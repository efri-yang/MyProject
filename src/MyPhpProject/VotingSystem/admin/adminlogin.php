<?php
    ...
    if(isset($_POST["username"]) && isset($_POST["pwd"])){
        ...
        if(empty($username) || empty($password)){
            ...
            $sql="select * from admin where username='$username' and password='$pwdMd5'";
...
<div class="container">
    <div class="row">
        <?php
            if($emptyFlag){
        ?>
                <div class="error-loginbox">管理员账号或者密码不能为空</div>
        <?php
            }
        ...
        ?>
                 <div class="error-loginbox" id="J_error-loginbox">
                    ...
                    <?php 
                        if(!$validFlag){
                            echo '<div class="txt">您输入管理员账号或者密码错误！</div>';
                        }
                     ?>
                     </div>
                 </div>
        
        <form class="form-horizontal" action="./adminlogin.php" method="post" id="logoForm">
