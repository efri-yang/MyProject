...
gulp.task('dist', gulp.series(cleans.DistClean,scripts.DistScripts,styles.DistStyles,htmls.DistHtmls,gulp.parallel(images.DistImages,watchs.DistWatchs,servers.DistServer)));
