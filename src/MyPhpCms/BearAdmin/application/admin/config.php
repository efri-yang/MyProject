...
return [
    ...
    'view_replace_str' => [
        ...
        '__STATIC__' => '/MyProject/src/MyPhpCms/BearAdmin/public/static/admin',
        '__CSS__' => '/MyProject/src/MyPhpCms/BearAdmin/public/static/admin/css',
        '__JS__' => '/MyProject/src/MyPhpCms/BearAdmin/public/static/admin/js',
        '__IMAGES__' => '/MyProject/src/MyPhpCms/BearAdmin/public/static/admin/images',
        '__FONTS__' => '/MyProject/src/MyPhpCms/BearAdmin/public/static/admin/fonts',
        '__PLUGINS__' => '/MyProject/src/MyPhpCms/BearAdmin/public/static/admin/plugins',
        '__AVATAR__' => '/MyProject/src/MyPhpCms/BearAdmin/public/uploads/admin/avatar',
    ],
