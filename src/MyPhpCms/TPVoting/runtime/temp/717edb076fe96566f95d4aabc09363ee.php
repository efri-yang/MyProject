<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"G:\xampp\htdocs\MyProject\src\MyPhpCms\TPVoting\public/../application/admin\view\user\profileEdit.html";i:1520341988;s:82:"G:\xampp\htdocs\MyProject\src\MyPhpCms\TPVoting\application\admin\view\layout.html";i:1522221703;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body class="layui-layout-body">
    ...
    <div class="layui-col-md6 layui-col-md-offset1">
        <form class="layui-form" action="<?php echo url('admin/user/updateProfile'); ?>" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="coms-zoom-img">
                       ...
                       <!--  <input type="hidden" name="thumbnail" id="J_thumbnail-ipt" value="<?php echo $web_data['user_info']['avatar']; ?>"> -->
                    </div>
                </div>
            </div>
           <!--  <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <?php if(!!$web_data['user_info']['birthday']): ?>
                         <input type="text" name="birthday" id="birthday" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" value="<?php echo $web_data['user_info']['birthday']; ?>" >
                    <?php else: ?> 
                         <input type="text" name="birthday" id="birthday"  placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" value="">
                    <?php endif; ?>
