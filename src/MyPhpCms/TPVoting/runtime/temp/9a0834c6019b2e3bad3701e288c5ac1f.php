<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"E:\Xampp\htdocs\MyProject\src\MyPhpCms\TPVoting\public/../application/admin\view\user\profileEdit.html";i:1520326353;s:82:"E:\Xampp\htdocs\MyProject\src\MyPhpCms\TPVoting\application\admin\view\layout.html";i:1520301531;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <?php if(!!$web_data['user_info']['birthday']): ?>
                         <input type="text" name="birthdate" id="birthdate" lay-verify="birthdate" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" value="<?php echo $web_data['user_info']['birthday']; ?>" disabled>
                    <?php else: ?> 
                         <input type="text" name="birthdate" id="birthdate" lay-verify="birthdate" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" value=" " disabled>
                    <?php endif; ?>
