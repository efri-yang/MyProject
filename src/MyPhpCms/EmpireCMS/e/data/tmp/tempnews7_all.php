					...
					<td><table width="100%" border="0" cellpadding="3" cellspacing="2">
						...
						<tr>
							...
							<td><table width="100%" border="0" cellpadding="3" cellspacing="2">
								...
								<tr>
									<td>[<a href="#ecms" onclick="window.open('/MyProject/src/MyPhpCms/EmpireCMS/e/ShopSys/doaction.php?enews=AddBuycar&amp;classid=<?=$ecms_gr[classid]?>&amp;id=<?=$ecms_gr[id]?>','','width=680,height=500,scrollbars=yes,resizable=yes');">加入购物车</a>]&nbsp;&nbsp;&nbsp;&nbsp;[<a href="/MyProject/src/MyPhpCms/EmpireCMS/e/member/fava/add/?classid=<?=$ecms_gr[classid]?>&amp;id=<?=$ecms_gr[id]?>" target="_blank">放入收藏夹</a>]&nbsp;&nbsp;&nbsp;&nbsp;[<a href="/MyProject/src/MyPhpCms/EmpireCMS/e/pl/?classid=<?=$ecms_gr[classid]?>&amp;id=<?=$ecms_gr[id]?>" target="_blank">查看评论</a>]</td>
								</tr>
							</table></td>
						</tr>
						<tr>
